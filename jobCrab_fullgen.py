...
config.JobType.scriptExe = 'gen_job_fullgen.sh'
#config.JobType.scriptArgs = ["0"]

#config.JobType.outputFiles = ['step0-GS-'+channel+gen_frag+'-result.root']
config.JobType.outputFiles = ['step0-GS-'+channel+gen_frag+'-result.root', 'step3-MINIAODSIM-'+channel+gen_frag+'-result.root']
