...
# with command line options: Configuration/GenProduction/python/ZtoJpsiMuMu_BPH-NoISR-fragment.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN --geometry DB:Extended --era Run2_2018 --python_filename step0-GS-ZtoJpsiMuMu_BPH-NoISR-run_cfg.py --fileout file:step0-GS-ZtoJpsiMuMu_BPH-NoISR-result.root --no_exec --mc -n 5
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/ZtoJpsiMuMu_BPH-NoISR-fragment.py nevts:5'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step0-GS-ZtoJpsiMuMu_BPH-NoISR-result.root'),
